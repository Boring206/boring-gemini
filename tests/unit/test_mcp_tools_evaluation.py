...
class TestEvaluationTools:
    ...
    def test_boring_evaluate_rate_limited(self, temp_project):
        ...
        with patch(
            "boring.mcp.tools.evaluation.check_rate_limit", return_value=(False, "Rate limited")
        ):
            result = evaluation.boring_evaluate(target="test.py", project_path=str(temp_project))
    ...
    def test_boring_evaluate_direct_mode(self, temp_project):
        ...
        with (
            ...
            result = evaluation.boring_evaluate(
                target="test.py", level="DIRECT", project_path=str(temp_project)
            )
    ...
    def test_boring_evaluate_file_path(self, temp_project):
        ...
        with (
            ...
            evaluation.boring_evaluate(target="test.py", project_path=str(temp_project))
    ...
    def test_boring_evaluate_pairwise_mode(self, temp_project):
        ...
        with (
            ...
            evaluation.boring_evaluate(
                target="file1.py,file2.py", level="PAIRWISE", project_path=str(temp_project)
            )
    ...
    def test_boring_evaluate_pairwise_invalid(self, temp_project):
        ...
        with (
            ...
            result = evaluation.boring_evaluate(
                target="single_file.py", level="PAIRWISE", project_path=str(temp_project)
            )
    ...
    def test_boring_evaluate_interactive_mode(self, temp_project):
        ...
        with (
            ...
            result = evaluation.boring_evaluate(
                target="test.py", interactive=True, project_path=str(temp_project)
            )
