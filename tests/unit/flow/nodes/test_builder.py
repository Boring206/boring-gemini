...
class TestBuilderNode:
    ...
    def test_process_tasks_incomplete(self, builder, context):
    ...
    def test_process_tasks_complete(self, builder, context):
    ...
    def test_process_handles_loop_exception(self, builder, context):
