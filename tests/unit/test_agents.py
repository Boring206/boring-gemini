...
class TestAgentBase:
    ...
    def test_shared_resource(self):
        ...
        from boring.agents.base import AgentRole, SharedResource
    ...
    def test_agent_context(self, tmp_path):
        ...
        context = AgentContext(project_root=tmp_path, task_description="Build feature X")
...
class TestArchitectAgent:
    ...
    def test_architect_system_prompt(self):
        ...
        assert (
            "NEVER write actual code" in prompt.upper()
            or "NEVER writes code" in prompt.upper()
            or "NEVER" in prompt
        )
...
class TestOrchestratorInit:
    ...
    def test_orchestrator_creates_agents(self, tmp_path):
        ...
        orchestrator = AgentOrchestrator(llm_client=mock_client, project_root=tmp_path)
