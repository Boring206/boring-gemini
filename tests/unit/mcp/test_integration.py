...
from boring.mcp.tools.integration import boring_notebooklm_guide, boring_setup_extensions
...
class TestIntegrationTools:
    ...
    def test_boring_setup_extensions_success(self, mock_extensions_cls, mock_get_root):
        ...
        mock_manager.install_recommended_extensions.return_value = {"ext1": (True, "Installed")}
