...
from boring.rag.parser import TreeSitterParser, ParsedChunk
...
def test_parser_extract_chunks_mocked(mock_get_parser, mock_get_curr_lang):
    ...
    assert chunks[0].name == "anonymous" # Name logic in our parser requires parent/child relations we didn't fully mock
