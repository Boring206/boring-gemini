...
class TestAgentLoop:
    ...
    def test_init_sdk_mode(self, temp_project, mock_gemini_client):
        ...
        with patch("boring.loop.legacy.settings") as mock_settings, \
    ...
    def test_run_circuit_breaker_resume(self, temp_project, mock_gemini_client):
        ...
        with patch("boring.loop.legacy.settings") as mock_settings, \
            ...
            with patch("boring.interactive.enter_interactive_mode", return_value=True), \
    ...
    def test_generate_step_sdk(self, temp_project, mock_gemini_client):
        ...
        with patch("boring.loop.legacy.settings") as mock_settings, \
            ...
            with patch("boring.loop.legacy.time.strftime", return_value="2024-01-01_00-00-00"), \
