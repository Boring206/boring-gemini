...
class TestPendingOperation:
    ...
    def test_pending_operation_creation(self):
        ...
        from boring.shadow_mode import PendingOperation, OperationSeverity
...
class TestShadowModeGuard:
    ...
    def test_guard_strict_mode(self, tmp_path):
        ...
        guard = ShadowModeGuard(
            project_root=tmp_path,
            mode=ShadowModeLevel.STRICT
        )
        
        # Even medium severity should be blocked
        result = guard.check_operation({
            "name": "write_file",
            "args": {"file_path": "normal.py", "content": "x = 1"}
        })
    ...
    def test_guard_sensitive_file_detection(self, tmp_path):
        ...
        from boring.shadow_mode import ShadowModeGuard, ShadowModeLevel, OperationSeverity
        ...
        result = guard.check_operation({
            "name": "write_file",
            "args": {"file_path": ".env", "content": "SECRET=xxx"}
        })
