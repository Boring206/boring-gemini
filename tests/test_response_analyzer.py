...
class TestAnalyzeResponse:
    ...
    def test_analyze_response_with_function_call_results(self, tmp_path, monkeypatch):
        ...
        result = analyze_response(output_file, loop_number=5, function_call_results=function_results)
...
""")
    ...
    def test_analyze_response_in_progress_status(self, tmp_path, monkeypatch):
        ...
        result = analyze_response(output_file, loop_number=3, function_call_results=function_results)
    ...
    def test_analyze_response_function_calls_override_text(self, tmp_path, monkeypatch):
        ...
        result = analyze_response(output_file, loop_number=2, function_call_results=function_results)
