...
# 3. ANALYZE
[command.subcommands.analyze]
description = "Analyze consistency between specs and code"
[command.subcommands.analyze.prompt]
text = """
...
# 4. CLARIFY
[command.subcommands.clarify]
description = "Clarify ambiguous requirements"
[command.subcommands.clarify.prompt]
text = """
...
"""
# 5. CONSTITUTION
[command.subcommands.constitution]
description = "Create project constitution (Principles & Guidelines)"
[command.subcommands.constitution.prompt]
text = """
...
# 6. CHECKLIST
[command.subcommands.checklist]
description = "Generate quality checklist for requirements"
[command.subcommands.checklist.prompt]
text = """
