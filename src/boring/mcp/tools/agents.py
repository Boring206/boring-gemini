...
def boring_delegate(
    ...
    tool_type: Annotated[str, Field(description="Type of tool to delegate to ('database', 'web_search', 'file_system', 'api', 'reasoning')")],
    project_path: Annotated[str, Field(description="Optional explicit path to project root")] = None
) -> dict:
    """
...
def register_agent_tools(mcp, helpers: dict):
    ...
    mcp.tool(description="Run full multi-agent workflow (Architect -> Coder -> Reviewer)", annotations={"readOnlyHint": True, "openWorldHint": True})(boring_multi_agent)
    mcp.tool(description="Run Architect agent to create implementation plan", annotations={"readOnlyHint": True, "openWorldHint": True})(boring_agent_plan)
    mcp.tool(description="Run Reviewer agent on existing code", annotations={"readOnlyHint": True, "openWorldHint": True})(boring_agent_review)
    mcp.tool(description="Delegate task to a specialized agent/tool", annotations={"readOnlyHint": True, "openWorldHint": True})(boring_delegate)
