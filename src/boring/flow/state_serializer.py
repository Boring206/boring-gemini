...
class StateSerializer:
    ...
    def save_checkpoint(
        ...
        try:
            # Safe handling for memory object serialization
            memory_val = str(context.memory)
            if isinstance(context.memory, (dict, list, str, int, float, bool, type(None))):
                memory_val = context.memory
