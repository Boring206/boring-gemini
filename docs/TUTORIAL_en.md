...
- 📚 [Full Tool Reference](APPENDIX_A_TOOL_REFERENCE.md) — All 55+ Tools
- ❓ [FAQ](APPENDIX_B_FAQ.md) — Troubleshooting
- 🏛️ [Prompt Philosophy](APPENDIX_C_PROMPT_PHILOSOPHY.md) — Architect Persona Design
