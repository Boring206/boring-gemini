...
| 教學 | 時間 | 技能水平 |
|------|------|----------|
| [1. 你的第一個 Vibe 專案](#first-vibe-project) | 5 分鐘 | 初學者 |
| [2. 一鍵修復所有錯誤](#one-click-fix) | 3 分鐘 | 初學者 |
| [3. 新增功能](#add-feature) | 10 分鐘 | 中級 |
| [4. AI 代碼審查](#ai-review) | 5 分鐘 | 中級 |
| [5. 設定品質閘道](#quality-gates) | 10 分鐘 | 進階 |
| [6. 多代理開發](#multi-agent) | 15 分鐘 | 進階 |

---

## 你的第一個 Vibe 專案 {: #first-vibe-project }
