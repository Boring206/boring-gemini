...
**Simplifying Onboarding & Resource Control**
- **Zero-Config Wizard**: One-click `boring wizard` for MCP setup in Cursor/VS Code/Claude.
- **PRO-Files**: Standard/Lite/Full/Custom profile selection for granular token control.
- **Security**: Enhanced file interceptors for Shadow Mode stability.
...
- [Release Notes](../index.md#changelog) - Detailed release notes
- [Features](../index.md#features) - Feature documentation
