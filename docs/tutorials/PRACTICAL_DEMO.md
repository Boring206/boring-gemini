...
```
你: "幫我建立一個 FastAPI 認證服務，要有 JWT 和 GitHub OAuth"
...
> 💡 **V10.24 提示**：使用 `boring-route` CLI 或自然語言對話，系統會自動路由到正確的工具。
...
- [工具清單](../reference/APPENDIX_A_TOOL_REFERENCE_zh.md) — 所有 55+ 個工具
